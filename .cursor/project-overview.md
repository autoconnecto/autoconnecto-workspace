...
- `website/`: Next.js 15 App Router marketing site, static export (standalone repo: `https://github.com/autoconnecto/website`; see `docs/WEBSITE-STANDALONE-REPOSITORY.md`).
- `autoconnecto-mobile/`: React Native (Expo) mobile app (`https://github.com/autoconnecto/autoconnecto-mobile`).
