...
| Versioned APK | [`machine-worker-app/autoconnecto-worker-v1.2.9.apk`](machine-worker-app/autoconnecto-worker-v1.2.9.apk) |
...
# 2. Commit, push, tag:
git tag worker-v1.2.9
git push origin worker-v1.2.9
...
2. Install **Worker app v1.2.9** on the phone.
